...
# abc123 회원이 1번 스케쥴(미키 17, 1관, 3월 11일, 13:50)의 예약 가능한 좌석 A1, A2를 예매했을 때 필요한 쿼리
INSERT INTO TICKET(TI_ADULT, TI_TEEN, TI_PRICE, TI_ME_NUM, TI_SD_NUM)
...
# abc123 회원이 2번 스케쥴(미키 17, 1관, 3월 11일, 19:20)의 예약 가능한 좌석 A1, A2를 예매했을 때 필요한 쿼리
INSERT INTO TICKET(TI_ADULT, TI_TEEN, TI_PRICE, TI_ME_NUM, TI_SD_NUM)
...
# abc123 회원이 2번 스케쥴(미키 17, 1관, 3월 11일, 19:20)의 예약 가능한 좌석 A3, A4를 예매했을 때 필요한 쿼리
INSERT INTO TICKET(TI_ADULT, TI_TEEN, TI_PRICE, TI_ME_NUM, TI_SD_NUM)
VALUES(1, 1, 27000, 1, 2);
INSERT INTO TICKET_LIST(TL_TI_NUM, TL_SE_NUM) VALUES(4,40), (4,41);
UPDATE SCHEDULE SET SD_POS_SEAT = SD_POS_SEAT - 2 WHERE SD_NUM = 2;

# abc123회원이 2번 스케쥴에 예약했던 A3, A4를 취소했을 때 필요한 쿼리
