...
CREATE TABLE [IF NOT EXISTS] 테이블명(
        ...
        ...,
        [ CONSTRAINT 제약조건명 PRIMARYKEY(컬럼명),]
        [ PRIMARY KEY(컬럼명),]
...
DROP TABLE IF EXISTS STBJECT.SUBJECT;
...
CREATE TABLE STUDENT.SCORE(
    ...
    SC_ST_KEY INT NOT NULL, -- ST_KEY와 SJ_NUM은 외래키이기에 타입을 맞춰야돼서 INT
...
외래키 UPDATE, DELETE 옵션
 ...
 - SET NULL
  - 참조 테이블에 기본키가 삭제/수정되면 참조하는 테이블의 외래키를 NULL로 변경. 외래키가 NULL허용일 때 가능
 - NO ACTION
