 	...
 	${list}
 		...
 		<script type="text/javascript">
 			$(".btn-update").click(function (e){
 				var $content = $(this).parents(".comment-item").find(".comment-content") //$content는 jquery 요소임. $붙이는 이유는 구분짓기 위해 jquery 요소라는 것을.
 				$content.hide();
 				
 				var co_content = $content.text();
 				var co_num = $(this).data("num"); // <data-num>에서 data-는 제공해주는건데 num은 지정한 것.
 				//다르게 지정해도 되는됨
 				//$(this).attr("data-num"); 이런식으로 해야함 근데
