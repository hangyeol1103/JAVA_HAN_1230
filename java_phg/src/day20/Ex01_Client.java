...
public class Ex01_Client {
	...
	private static void login() {
		...
		String autority = user.getAuthority();
	...
	private static void signup() {
		...
		if(!pw.equals(pw2)) { //문자열 비교는 ==가 아닌 equals로 함.
	...
	private static void insertProduct() {
		...
		int count = getLasNum(list, codePrefix);
	...
	private static int getLasNum(List<Product> list, String codePrefix) {
		if(list == null) {
			return -1;
		}
		int max = 0;
