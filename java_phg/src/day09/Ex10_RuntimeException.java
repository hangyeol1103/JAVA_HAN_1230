...
public class Ex10_RuntimeException {
	...
	public static void main(String[] args) {
		...
		/* ArithmeticaException : 0으로 나누었을 때 발생. a/0, a%0 */
		int num1 = 1, num2 = 0;
		//System.out.println(num1 / num2); //예외 발생
		System.out.println(num1 / (double)num2); //정상 실행.

		/* NullPointerException : 객체를 생성하지 않고 null인 상태로 필드나 메소드를 호출하는 경우 발생 */
		String str = null;
		...
		/* ClassCastException : 다운 캐스팅에서 발생. 부모 클래스의 객체를 자식 클래스에 개체로 클래스 형변환 하는 경우 발생
