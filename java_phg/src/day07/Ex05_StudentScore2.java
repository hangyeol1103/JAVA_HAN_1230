...
public class Ex05_StudentScore2 {
	...
	public static void main(String[] args) {
		...
		list[count] = new Student(1, 1, 1, "홍길동", "국어", 100); //객체 생성후 추가. count를 0으로 했기에 0대신 count 입력
		count++; //하나 입력 됐으니 count++
		do {
			//메뉴를 출력
			...
			case 1:
				...
				System.out.print("번호 : ");
				int num = scan.nextInt(); //next()는 띄어쓰기를 안하는 것. nextLine()은 엔터가 입려되어있.
				System.out.print("이름 : ");
				...
				list[count] = tmp;
				//grade, classNum, num, subject가 일치하는 정보가 list에 있는지 확인 해서
				...
				break;
			case 2:
				/* 0번지부터 count-1번까지 1씩 증가하면서 list에 있는
			...
			case 3:
				...
				System.out.print("번호 : ");
				num = scan.nextInt(); //next()는 띄어쓰기를 안하는 것. nextLine()은 엔터가 입려되어있
				System.out.print("과목 : ");
				subject = scan.next();
			...
			case 4:
				...
				if(index >= 0 ) {
					...
					/*if(index != count -1) {
						...
						System.arraycopy(list, index+1, arr, count - index, -1);
						list = arr;
						}
					*/
